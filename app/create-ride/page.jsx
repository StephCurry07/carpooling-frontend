...
const createRide = () => {
    ...
    const handleChangePass = (e) => {
        ...
        if ((inputValue <= 1 && flag == 1) || (inputValue >= formData.carCapacity && flag == 1)) {
    ...
    const handleSubmit = async (e) => {
        ...
        // Car details
        const newCarDetails = `${formData.carName} ${formData.maxPassengers || maxPassengers} Seater ${acNonAc}`;
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className={styles.carInput}>
                        ...
                        <div className={styles.acNonAc}>
                            ...
                            value='AC'
                            defaultChecked={true}
                            onChange={handleChangeRad} /> AC
                            <input
                            type='radio'
                            name='acNonAc'
                            value='Non-AC'
                            onChange={handleChangeRad} /> Non-AC
                        </div>
                    </div>
